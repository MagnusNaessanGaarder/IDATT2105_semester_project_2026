  ...
  <div class="view-page alkohol-dashboard">
    ...
    <section class="dashboard-grid" aria-label="Hovedseksjoner for IK-Alkohol">
      <article class="action-card">
        ...
        <router-link :to="{ name: 'DailyControl' }" class="action-card__link">Vis mer</router-link>
      </article>
      ...
      <article class="action-card">
        ...
        <router-link :to="{ name: 'Certifications' }" class="action-card__link">Vis mer</router-link>
      </article>
      ...
      <article class="action-card">
        ...
        <router-link :to="{ name: 'Regulations' }" class="action-card__link">Vis mer</router-link>
      </article>
    </section>
...
.action-card__link:hover {
  color: color-mix(in srgb, var(--ik-alkohol-primary) 80%, black);
}
