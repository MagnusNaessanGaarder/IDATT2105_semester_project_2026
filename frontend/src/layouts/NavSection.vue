  ...
  >
    ...
    >
      <template #icon>
        ...
        <svg
          v-else-if="section.icon === 'FolderOpen'"
          width="18"
          height="18"
          viewBox="0 0 24 24"
          fill="none"
          ...
          stroke-width="2"
        >
          <path d="M6 7h11.5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2z" />
          <path d="M6 7V5a2 2 0 0 1 2-2h4.5" />
          <path d="M6 7l2-2h3" />
        </svg>
        <svg
          v-else-if="section.icon === 'Settings'"
          width="18"
          height="18"
          viewBox="0 0 24 24"
          fill="none"
