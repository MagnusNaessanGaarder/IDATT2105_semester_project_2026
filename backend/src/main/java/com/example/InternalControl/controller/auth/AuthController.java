...
public class AuthController {
     ...
     *
     * @param request the registration request containing email, password, full name, and phone
     * @return ResponseEntity with AuthResponse containing JWT tokens (HTTP 201)
     * @throws IllegalArgumentException if email already exists or input validation fails
     */
