...
/**
 * Centralized authentication and authorization utility.
...
public class AuthenticationFacade {
    ...
    public void validateManagerOrAdminAccess(Long userId, Integer orgNumber) {
        if (!userOrgService.isUserManagerOrAdmin(userId, orgNumber)) {
            throw new AccessDeniedException("Only managers or admins can perform this action");
        }
    }
